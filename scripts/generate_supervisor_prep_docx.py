...
def create_supervisor_prep_docx():
    ...
    lims = [
        ("Limitation 1: Model Field Accuracy Below Production Floor",
         ...
         "• Here's what I'm doing about it: I implemented a multi-tier safety net: mandatory low-confidence gating (threshold = 0.60), Google Gemini 1.5 Flash visual cloud audits for uncertain scans, and built-in escalation paths to certified Agricultural Extension Officers."),
